...
public class LoadingScreen extends Screen {
	...
	public void update(float deltaTime) {
		...
		Assets.character2 = g.newImage("character2.jpg",  ImageFormat.ARGB4444);
		Assets.character3 = g.newImage("character3.jpg",  ImageFormat.ARGB4444);
		...
		//Assets.click = game.getAudio().createSounds("explode.ogg");
