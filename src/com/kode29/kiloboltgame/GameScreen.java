...
public class GameScreen extends Screen {
	...
	private void loadMap() {
		...
		while (scanner.hasNextLine()) {
			...
			String line = scanner.nextLine(); // Equivalent to
												// "foreach ($line as $l){ }";
	...
	public void update(float deltaTime) {
		...
		// We have 4 seperate update methods in this example
		// Depending on the state of the game, we call different update methods.
		// REfer to Unit 3's code. We did a similar thing without seperating the
		// update methods
